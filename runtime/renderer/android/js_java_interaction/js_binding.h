...
#ifndef XWALK_RUNTIME_RENDERER_ANDROID_JS_JAVA_INTERACTION_JS_BINDING_H_
#define XWALK_RUNTIME_RENDERER_ANDROID_JS_JAVA_INTERACTION_JS_BINDING_H_
...
class JsBinding : public gin::Wrappable<JsBinding> {
 public:
  ...
  static std::unique_ptr<JsBinding> Install(content::RenderFrame* render_frame, const std::string& js_object_name);
...
#endif  // XWALK_RUNTIME_RENDERER_ANDROID_JS_JAVA_INTERACTION_JS_BINDING_H_
