...
#ifndef XWALK_RUNTIME_RENDERER_ANDROID_JS_JAVA_INTERACTION_JS_JAVA_CONFIGURATOR_H_
#define XWALK_RUNTIME_RENDERER_ANDROID_JS_JAVA_INTERACTION_JS_JAVA_CONFIGURATOR_H_
...
class JsJavaConfigurator : public mojom::JsJavaConfigurator,
 ...
 public:
  ...
  void SetJsApiService(bool inject_js_object, const std::string& js_object_name,
 ...
 private:
  void BindPendingReceiver(mojo::PendingAssociatedReceiver<mojom::JsJavaConfigurator> pending_receiver);
...
#endif  // XWALK_RUNTIME_RENDERER_ANDROID_JS_JAVA_INTERACTION_JS_JAVA_CONFIGURATOR_H_
