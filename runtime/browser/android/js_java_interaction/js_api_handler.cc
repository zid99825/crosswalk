...
void JsApiHandler::PostMessage(
  ...
  XWalkContent* xwalk_contents = XWalkContent::FromWebContents(web_contents);
...
//
//  if (!xwalk_contents->IsOriginAllowedForOnPostMessage(source_origin))
//    return;
//
