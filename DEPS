...
deps = {
    ...
    'src/xwalk/third_party/tenta/meta_fs' : 'git@bitbucket.org:mikandi/file-metadata-sqlite.git@origin/feature/ff',
    'src/xwalk/third_party/tenta/chromium_cache' : 'git@bitbucket.org:mikandi/chromium-cache-metafs.git@origin/feature/ff',
    'src/xwalk/third_party/tenta/crosswalk_extensions' : 'git@bitbucket.org:mikandi/crosswalk-extensions.git@origin/feature/ff',
